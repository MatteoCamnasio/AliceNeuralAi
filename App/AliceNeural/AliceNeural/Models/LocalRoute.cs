...
namespace AliceNeural.Models
{
...

    {
        ...
        public class GeocodePointRoute
        {
...

    {
        ...
        public List<ResourceRoute> Resources { get; set; }
...

    {
        ...
        public List<ResourceSetRoute> ResourceSets { get; set; }
